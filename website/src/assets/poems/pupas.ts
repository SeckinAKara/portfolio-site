...
let line5 = new Line([common_words.you, meet, one, common_words["you've"], met, common_words.none.rightSeparator('')], Line_Alignment.LEFT);
...
let line7 = new Line([common_words.i, common_words.see, futures, common_words.in, common_words.your, common_words.eyes.rightSeparator('')], Line_Alignment.LEFT);
...
let line8 = new Line([common_words["you'll"], wreck, common_words.the, whole, damn, common_words.world.rightSeparator('')], Line_Alignment.LEFT);
...
let line14 = new Line([queers, common_words.never, common_words.die.rightSeparator('')], Line_Alignment.LEFT);
