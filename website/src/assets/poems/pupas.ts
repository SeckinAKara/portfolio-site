...
let queers = new Word('queers', new Pronunciation(['kwERz']));
let born = new Word("born", new Pronunciation(['bORn']));
let line1 = new Line([queers, common_words["aren't"], born], Line_Alignment.LEFT);

let we_re = new Word("we're", new Pronunciation(['wER']));
let revealed = new Word("revealed", new Pronunciation(['r.', 'vEld'], [1]));
let line2 = new Line([we_re, revealed], Line_Alignment.LEFT);
...
let line3 = new Line([common_words.with, old, eyes, common_words.and, deep, chests], Line_Alignment.LEFT);
...
let line4 = new Line([enclosing, common_words.each, others, wispy, gasps], Line_Alignment.LEFT);
...
let line5 = new Line([common_words.you, meet, one, common_words["you've"], met, common_words.none], Line_Alignment.LEFT);
...
let line6 = new Line([common_words["we're"], common_words.all, different, tomorrow, today], Line_Alignment.LEFT);

let futures = new Word("futures", new Pronunciation(['fyU', 'CRz'], [0]));
let line7 = new Line([common_words.i, common_words.see, futures, common_words.in, common_words.your, common_words.eyes], Line_Alignment.LEFT);
...
let line8 = new Line([common_words["you'll"], wreck, common_words.the, whole, damn, common_words.world], Line_Alignment.LEFT);

let climbing = new Word("climbing", new Pronunciation(['klIm', 'iN'], [0]));
let mountains = new Word("mountains", new Pronunciation(['mawn', '-nz']));
let line9 = new Line([common_words.just, climbing, common_words.your, common_words.own, mountains], Line_Alignment.LEFT);

let spinning = new Word("spinning", new Pronunciation(['spin', 'iN'], [0]));
let polyhedra = new Word("polyhedra", new Pronunciation(['pol', 'E', 'hE', 'dr.'], [2]));
let line10 = new Line([spinning, common_words.like, polyhedra], Line_Alignment.LEFT);

let lichenic = new Word("lichenic", new Pronunciation(['lI', 'ke', 'nik'], [1]));
let line11 = new Line([lichenic], Line_Alignment.LEFT);

let archaea = new Word("archaea", new Pronunciation(['aR', 'kE', '.'], [1]));
let line12 = new Line([archaea], Line_Alignment.LEFT);

let live = new Word("live", new Pronunciation(["liv"]));
let forever = new Word("forever", new Pronunciation(["fOR", 'e', 'vR'], [1]));
let half_wrote = new Word("half-wrote", new Pronunciation(["haf", "rOt"], [0]));
let texts = new Word("texts", new Pronunciation(["teksts"]));
let line13 = new Line([common_words["we'll"], live, forever, common_words.in, half_wrote, texts], Line_Alignment.LEFT);

let line14 = new Line([queers, common_words.never, common_words.die], Line_Alignment.LEFT);

let _return = new Word("return", new Pronunciation(["r.", "tRn"], [1]))
let line15 = new Line([common_words.we, common_words.just, _return], Line_Alignment.LEFT);

export const poem = new Full_Poem("pupas", [line1, line2, line3, line4, line5, line6, line7, line8, line9, line10, line11, line12, line13, line14, line15]);