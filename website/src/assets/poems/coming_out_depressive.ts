...
let line1 = new Line(0, [common_words.when, common_words.everything, common_words.that, catches, common_words.your, attention], Line_Alignment.LEFT);

let filamentous = new Word("filamentous", new Pronunciation(["fil", ".", "men", "tis"], [2]), '', ', ', "made of filaments");
let botanical = new Word("botanical", new Pronunciation(["b.", "tan", "i", "k.l"], [1]), '', ', ', "having to do with plants");
let fungal = new Word("fungal", new Pronunciation(["fuN", "g.l"], [0]), '', '');
let line2 = new Line(1, [common_words.is, filamentous, botanical, common_words.even, fungal], Line_Alignment.LEFT);
...
let line3 = new Line(2, [common_words.when, common_words.the, speed, limit, gains, legibility, common_words.as.rightSeparator('')], Line_Alignment.LEFT);

let days = new Word("days", new Pronunciation(['dAz']));
let line4 = new Line(3, [common_words.the, days, common_words.go, common_words.by], Line_Alignment.LEFT);
...
let line5 = new Line(4, [common_words.when, living, musicians, sound, common_words.as, common_words.good], Line_Alignment.LEFT);
...
let line6 = new Line(5, [common_words.as, common_words.the, ones, common_words.that, killed, themselves], Line_Alignment.LEFT);
...
let line7 = new Line(6, [common_words.when, common_words.the, kitchen, becomes, common_words.less, intimidating], Line_Alignment.LEFT);
...
let line8 = new Line(7, [common_words.when, common_words.the, earth_s, diameter, returns, common_words.to, normal], Line_Alignment.LEFT);
...
let line9 = new Line(8, [common_words.I, think, common_words.I, can, finish, common_words.a, movie, now], Line_Alignment.LEFT);
...
let line10 = new Line(9, [there_s, common_words.so, many, common_words.to, choose, common_words.from], Line_Alignment.LEFT);
